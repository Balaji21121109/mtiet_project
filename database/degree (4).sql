...
(4, 'CLASSROOM', '1', 123, 8, 123, 8, 8, 88, 8, 8, 8, 88, 8, 88, 8, 8, 88),
(44, 'CLASSROOM', '1', 44, 4, 44, 44, 4, 44, 4, 44, 4, 44, 4, 4, 4, 4, 44),
(888, 'CLASSROOM', '1', 123, 8, 123, 8, 8, 88, 8, 8, 8, 88, 8, 88, 8, 8, 88);
...
CREATE TABLE IF NOT EXISTS `information` (
  ...
  `dusktwo` int(10) NOT NULL,
  `duskthree` int(10) NOT NULL,
  `duskfour` int(10) NOT NULL,
  `readingtb` int(10) NOT NULL,
  `longtb` int(11) NOT NULL,
  `smalltb` int(11) NOT NULL,
  `officetb` int(11) NOT NULL,
  `chair` int(11) NOT NULL,
  `execchair` int(11) NOT NULL,
  `libalm` int(11) NOT NULL,
  `offalm` int(11) NOT NULL,
  `openrack` int(11) NOT NULL,
  `woodenr` int(11) NOT NULL,
  `comtables` int(11) NOT NULL,
  `podiums` int(11) NOT NULL,
  `fans` int(11) NOT NULL,
  `greenboards` int(11) NOT NULL,
  `wcooler` int(11) NOT NULL,
  `buletingboard` int(11) NOT NULL,
  `noticeboards` int(11) NOT NULL,
  `tubelights` int(11) NOT NULL,
  `windowcloths` int(11) NOT NULL,
  `intercom` int(11) NOT NULL,
  `computers` int(11) NOT NULL,
  `projecter` int(11) NOT NULL,
  `mirror` int(11) NOT NULL,
  `watches` int(11) NOT NULL,
  `phone` int(11) NOT NULL,
  `lcdscr` int(11) NOT NULL,
  `lcdbox` int(11) NOT NULL,
  `ohp` int(11) NOT NULL,
  `steeltool` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `information` (`room`, `purpose`, `dept`, `dusktwo`, `duskthree`, `duskfour`, `readingtb`, `longtb`, `smalltb`, `officetb`, `chair`, `execchair`, `libalm`, `offalm`, `openrack`, `woodenr`, `comtables`, `podiums`, `fans`, `greenboards`, `wcooler`, `buletingboard`, `noticeboards`, `tubelights`, `windowcloths`, `intercom`, `computers`, `projecter`, `mirror`, `watches`, `phone`, `lcdscr`, `lcdbox`, `ohp`, `steeltool`) VALUES
('322', 'CLASSROOM', 0, 22, 22, 22, 22, 0, 0, 2, 0, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 0, 2, 2, 2, 2, 2, 2),
('22', 'CLASSROOM', 0, 2, 2, 2, 2, 0, 4, 4, 0, 44, 4, 4, 48, 48, 55, 88, 48, 48, 48, 98, 55, 9898, 56, 55, 56, 555, 0, 222, 564, 66, 65, 66, 6);
...
(8, 'principal', 8, 88, 8, 88, 8, 0, 88, 8, 8, 88, 8, 88, 8, 8, 88, 8, 8, 8, 8, 88, 8, 88, 8, 8, 88, 8, 88, 8, 8, 88, 8, 8, 88, 8, 8, 8, 8, 88, 8, 88, 88, 8, 8, 8, 88, 8, 8, 8, 88, 8, 8, 8, 88, 8, 8, 8, 8, 88, 8, 8, 88, 8, 8, 88, 8, 8, 8, 8, 88);
